...
export default class App extends React.Component {
 ...
 makeDraggable = {
  ...
  dragMouseDown: (e) => {
   ...
   document.onmouseup = this.makeDraggable.closeDragElement;
   // call a function whenever the cursor moves
   document.onmousemove = this.makeDraggable.elementDrag;
  },
  ...
  elementDrag: (e) => {
   ...
   document.querySelectorAll(".__calculator-main")[0].style.top =
    document.querySelectorAll(".__calculator-main")[0].offsetTop -
    this.currentPosY +
    "px";
   document.querySelectorAll(".__calculator-main")[0].style.left =
    document.querySelectorAll(".__calculator-main")[0].offsetLeft -
    this.currentPosX +
    "px";
  },
   ...
   <>
    <div className="__calculator-main">
     ...
     <div className="__output">
      <div className="row1" onMouseDown={this.makeDraggable.dragMouseDown}>
       <p>
        <b>Reacto</b>
       </p>
       <p>
